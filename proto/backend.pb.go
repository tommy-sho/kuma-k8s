...
func (x *UserDetailResponse) GetDescription() string {
	if x != nil {
...
var file_backend_proto_rawDesc = []byte{
	...
	0x52, 0x02, 0x69, 0x64, 0x22, 0x5a, 0x0a, 0x12, 0x55, 0x73, 0x65, 0x72, 0x44, 0x65, 0x74, 0x61,
	...
	0x32, 0x48, 0x0a, 0x0d, 0x42, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x53, 0x65, 0x72, 0x76, 0x65,
	0x72, 0x12, 0x37, 0x0a, 0x0a, 0x55, 0x73, 0x65, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x12,
	0x12, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x71, 0x75,
...
var file_backend_proto_depIdxs = []int32{
	0, // 0: BackendServer.UserDetail:input_type -> UserDetailRequest
	1, // 1: BackendServer.UserDetail:output_type -> UserDetailResponse
...
func (c *backendServerClient) UserDetail(ctx context.Context, in *UserDetailRequest, opts ...grpc.CallOption) (*UserDetailResponse, error) {
	out := new(UserDetailResponse)
	err := c.cc.Invoke(ctx, "/BackendServer/UserDetail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedBackendServerServer can be embedded to have forward compatible implementations.
type UnimplementedBackendServerServer struct {
}

func (*UnimplementedBackendServerServer) UserDetail(context.Context, *UserDetailRequest) (*UserDetailResponse, error) {
...
func _BackendServer_UserDetail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserDetailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BackendServerServer).UserDetail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/BackendServer/UserDetail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackendServerServer).UserDetail(ctx, req.(*UserDetailRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _BackendServer_serviceDesc = grpc.ServiceDesc{
	ServiceName: "BackendServer",
	HandlerType: (*BackendServerServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "UserDetail",
			Handler:    _BackendServer_UserDetail_Handler,
		},
	},
